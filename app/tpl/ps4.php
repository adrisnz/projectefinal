...
echo '<script>location.href="'.APP_W.'ps4"</script>';
...
<div style="width:100%; text-align:center;"><h1>PS4</h1>
...
mysqli_set_charset($connect,"utf8");
    ...
    $queryXboxOne = mysqli_query($connect, "SELECT videojuegos.nombre, videojuegos.url_imagen, videojuegos.id_juego, videojuegos.nota_profesionales FROM videojuegos WHERE videojuegos.plataforma=2");
