...
echo '<script>location.href="'.APP_W.'xbox"</script>';
...
<div style="width:100%; text-align:center;"><h1>Xbox One</h1>
...
<table class="tabla_home" id="verda_xbox">
<thead>
  <tr>
    <th>Imagen</th>
    <th>Juego</th>
...
mysqli_set_charset($connect,"utf8");
    ...
    $queryXboxOne = mysqli_query($connect, "SELECT videojuegos.nombre, videojuegos.url_imagen, videojuegos.id_juego, videojuegos.nota_profesionales FROM videojuegos WHERE videojuegos.plataforma=1");
