...
echo '<script>location.href="'.APP_W.'ios"</script>';
...
<div style="width:100%; text-align:center;"><h1>iOS</h1>
...
<table class="tabla_home" id="gris_ios">
<thead>
  <tr>
    <th>Imagen</th>
    <th>Juego</th>
...
mysqli_set_charset($connect,"utf8");
    ...
    $queryXboxOne = mysqli_query($connect, "SELECT videojuegos.nombre, videojuegos.url_imagen, videojuegos.id_juego, videojuegos.nota_profesionales FROM videojuegos WHERE videojuegos.plataforma=4");
