...
--
-- Servidor: localhost
-- Tiempo de generación: 24-06-2015 a las 16:57:46
...
--
-- Base de datos: `2daw12_minimal`
--
CREATE DATABASE `2daw12_minimal` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `2daw12_minimal`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `analisisprofesionales`
--

CREATE TABLE IF NOT EXISTS `analisisprofesionales` (
  `id_analisis` int(11) NOT NULL AUTO_INCREMENT,
  `nota` float DEFAULT NULL,
  `texto` longtext,
  `urlanalisis` varchar(45) DEFAULT NULL,
  `videojuego` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_analisis`),
  KEY `fk_analisisProfesionales_videojuegos1_idx` (`videojuego`)
...
INSERT INTO `usuarios` (`id_usuario`, `email`, `password`, `token`) VALUES
(1, 'minimal@minimal.com', 'dc43e863c176e9b9f2a0b6054b24bd1a', ''),
(2, 'sanchez.adria1@gmail.com', 'db74acdf6376b2588260563c1eecae16', ''),
(3, 'john@minimal.com', '527bd5b5d689e2c32ae974c6229ff785', NULL),
(4, 'prueba@gmail.com', 'c893bad68927b457dbed39460e6afd62', NULL),
(5, 'dd', '4d186321c1a7f0f354b297e8914ab240', NULL),
(6, 'asd', '1aabac6d068eef6a7bad3fdf50a05cc8', NULL),
(7, 'prueba5@gmail.com', '96080775c113b0e5c3e32bdd26214aec', NULL),
(8, 'prueba5@gmail.com', '5afb9bcb73acf95a28aa35dbd9acdbda', NULL),
(9, 'adria@gmail.com', 'cba7fd79e3f4e142fdbd0be69eb45c6a', NULL);
...
CREATE TABLE IF NOT EXISTS `videojuegos` (
  ...
  `nombre` varchar(45) DEFAULT NULL,
  `nota_profesionales` float DEFAULT NULL,
  `url_imagen` varchar(45) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `plataforma` int(11) NOT NULL,
  PRIMARY KEY (`id_juego`),
  KEY `fk_videojuegos_plataformas_idx` (`plataforma`)
...
INSERT INTO `videojuegos` (`id_juego`, `nombre`, `nota_profesionales`, `url_imagen`, `fecha`, `plataforma`) VALUES
(15, 'Ryse', 6, 'pub/theme/k/img/ryse.jpg', '2015-04-16', 1),
(16, 'Fallout 4', 9, 'pub/theme/k/img/fallout.jpg', '2015-11-22', 2),
(17, 'Infinity Blade', 8, 'pub/theme/k/img/infinity.jpg', '2014-11-19', 4),
(18, 'Oceanhorn', 9, 'pub/theme/k/img/oceanhorn.jpg', '2014-09-30', 5),
(19, 'Batman', 8, 'pub/theme/k/img/batman.jpg', '2015-06-22', 3),
(20, 'The Witcher 3', 10, 'pub/theme/k/img/witcher.jpg', '2015-05-11', 3),
(21, 'Transistor', 10, 'pub/theme/k/img/transistor.jpg', '2015-06-16', 4),
(22, 'Uncharted 4', 8, 'pub/theme/k/img/uncharted.jpg', '2015-06-16', 2),
(23, 'Final Fantasy', 10, 'pub/theme/k/img/finalfantasy.jpg', '2015-06-10', 2),
(24, 'Halo 5', 8, 'pub/theme/k/img/halo5.jpg', '2015-06-12', 1),
(25, 'Gears of War', 9, 'pub/theme/k/img/gearsofwar.jpg', '2015-06-16', 1),
(26, 'Age of Empires', 8, 'pub/theme/k/img/aoe.jpg', '2002-12-24', 3),
(27, 'Angry Birds', 7, 'pub/theme/k/img/angrybirds.jpg', '2009-04-07', 4),
(28, 'Nova', 9, 'pub/theme/k/img/nova.jpg', '2015-05-25', 5),
(29, 'Jetpack', 7, 'pub/theme/k/img/jetpack.jpg', '2015-06-22', 5),
(30, 'Assassins', 6, '', '2015-06-16', 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `videojuegos_usuarios`
--

CREATE TABLE IF NOT EXISTS `videojuegos_usuarios` (
  `usuario` int(11) NOT NULL DEFAULT '0',
  `videojuego` int(11) NOT NULL DEFAULT '0',
  `nota` varchar(11) DEFAULT 'Puntuar',
  `favorito` tinyint(1) NOT NULL,
  PRIMARY KEY (`usuario`,`videojuego`),
  KEY `fk_videojuegos_usuarios_usuarios1_idx` (`usuario`),
  KEY `fk_videojuegos_usuarios_videojuegos1_idx` (`videojuego`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `videojuegos_usuarios`
--

INSERT INTO `videojuegos_usuarios` (`usuario`, `videojuego`, `nota`, `favorito`) VALUES
(1, 16, '9', 0),
(1, 17, 'Puntuar', 1),
(1, 18, 'Puntuar', 0),
(1, 19, '3', 1),
...
--
-- Filtros para la tabla `analisisprofesionales`
--
ALTER TABLE `analisisprofesionales`
  ADD CONSTRAINT `fk_analisisProfesionales_videojuegos1` FOREIGN KEY (`videojuego`) REFERENCES `videojuegos` (`id_juego`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `videojuegos`
--
ALTER TABLE `videojuegos`
  ADD CONSTRAINT `fk_videojuegos_plataformas` FOREIGN KEY (`plataforma`) REFERENCES `plataformas` (`id_plataforma`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `videojuegos_usuarios`
--
ALTER TABLE `videojuegos_usuarios`
  ADD CONSTRAINT `fk_videojuegos_usuarios_usuarios1` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_videojuegos_usuarios_videojuegos1` FOREIGN KEY (`videojuego`) REFERENCES `videojuegos` (`id_juego`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
...
('def', '2daw12_minimal', 'analisisprofesionales', 'id_analisis', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 'nota', 2, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 'texto', 3, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 'urlanalisis', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 'videojuego', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'plataformas', 'id_plataforma', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'plataformas', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'usuarios', 'id_usuario', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'usuarios', 'email', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'usuarios', 'password', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'usuarios', 'token', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'id_juego', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'nota_profesionales', 3, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'url_imagen', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'fecha', 5, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos', 'plataforma', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 'usuario', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 'videojuego', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 'nota', 3, 'Puntuar', 'YES', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 'favorito', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', '');
...
('BYTES_RECEIVED', '11046560'),
('BYTES_SENT', '330794575'),
...
('COM_SHOW_TABLE_STATUS', '1667'),
('COM_SHOW_TABLES', '1896'),
('COM_SHOW_TRIGGERS', '1243'),
('COM_SHOW_VARIABLES', '156'),
('COM_SHOW_WARNINGS', '37'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '0'),
('COM_STMT_EXECUTE', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '9342'),
('CREATED_TMP_DISK_TABLES', '3839'),
('CREATED_TMP_FILES', '34'),
('CREATED_TMP_TABLES', '12272'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '52685'),
('HANDLER_DELETE', '54'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '16696'),
('HANDLER_READ_KEY', '560077'),
('HANDLER_READ_LAST', '2'),
('HANDLER_READ_NEXT', '236858'),
('HANDLER_READ_PREV', '6156'),
('HANDLER_READ_RND', '365016'),
('HANDLER_READ_RND_NEXT', '3934193'),
('HANDLER_ROLLBACK', '1'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '17485'),
('HANDLER_WRITE', '237455'),
('INNODB_BUFFER_POOL_PAGES_DATA', '5406'),
('INNODB_BUFFER_POOL_BYTES_DATA', '88571904'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '5634'),
('INNODB_BUFFER_POOL_PAGES_FREE', '2774'),
('INNODB_BUFFER_POOL_PAGES_MISC', '11'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8191'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '304'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2631488'),
('INNODB_BUFFER_POOL_READS', '4899'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '13794'),
('INNODB_DATA_FSYNCS', '4396'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '87543808'),
('INNODB_DATA_READS', '5816'),
('INNODB_DATA_WRITES', '8647'),
('INNODB_DATA_WRITTEN', '186976768'),
('INNODB_DBLWR_PAGES_WRITTEN', '5634'),
('INNODB_DBLWR_WRITES', '783'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '3013'),
('INNODB_LOG_WRITES', '1334'),
('INNODB_OS_LOG_FSYNCS', '2083'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '1978368'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '197'),
('INNODB_PAGES_READ', '5209'),
('INNODB_PAGES_WRITTEN', '5634'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '0'),
('INNODB_ROW_LOCK_TIME_AVG', '0'),
('INNODB_ROW_LOCK_TIME_MAX', '0'),
('INNODB_ROW_LOCK_WAITS', '0'),
('INNODB_ROWS_DELETED', '54'),
('INNODB_ROWS_INSERTED', '897'),
('INNODB_ROWS_READ', '4364684'),
('INNODB_ROWS_UPDATED', '207'),
...
('THREADS_CACHED', '0'),
('THREADS_CONNECTED', '1'),
('THREADS_CREATED', '9341'),
('THREADS_RUNNING', '1'),
('UPTIME', '171563'),
('UPTIME_SINCE_FLUSH_STATUS', '171563');
...
('OLD_PASSWORDS', 'OFF'),
('GENERAL_LOG_FILE', '/var/lib/mysql/vps80486.log'),
...
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/vps80486-slow.log'),
...
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'analisisprofesionales', 'id_analisis', 1, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'fk_analisisProfesionales_videojuegos1', 'def', '2daw12_minimal', 'analisisprofesionales', 'videojuego', 1, 1, '2daw12_minimal', 'videojuegos', 'id_juego'),
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'plataformas', 'id_plataforma', 1, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'usuarios', 'id_usuario', 1, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'videojuegos', 'id_juego', 1, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'fk_videojuegos_plataformas', 'def', '2daw12_minimal', 'videojuegos', 'plataforma', 1, 1, '2daw12_minimal', 'plataformas', 'id_plataforma'),
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'videojuegos_usuarios', 'usuario', 1, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'PRIMARY', 'def', '2daw12_minimal', 'videojuegos_usuarios', 'videojuego', 2, NULL, NULL, NULL, NULL),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_usuarios1', 'def', '2daw12_minimal', 'videojuegos_usuarios', 'usuario', 1, 1, '2daw12_minimal', 'usuarios', 'id_usuario'),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_videojuegos1', 'def', '2daw12_minimal', 'videojuegos_usuarios', 'videojuego', 1, 1, '2daw12_minimal', 'videojuegos', 'id_juego');
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-06-24 16:57:46', '2015-06-24 16:57:46', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 16766844, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 16332350, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 16765866, 0, 0, '2015-06-24 16:57:46', NULL, NULL, NULL, '', '', NULL),
('def', '2daw12_minimal', 'analisisprofesionales', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2015-06-24 12:10:28', NULL, NULL, NULL, '', '', NULL),
('def', '2daw12_minimal', 'plataformas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2015-06-24 12:10:28', NULL, NULL, NULL, '', '', NULL),
('def', '2daw12_minimal', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 0, 0, '2015-06-24 12:10:28', NULL, NULL, NULL, '', '', NULL),
('def', '2daw12_minimal', 'videojuegos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16, 1024, 16384, NULL, 16384, 0, '2015-06-24 12:10:29', NULL, NULL, NULL, '', '', NULL),
('def', '2daw12_minimal', 'videojuegos_usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16, 1024, 16384, NULL, 32768, 0, '2015-06-24 12:10:29', NULL, NULL, NULL, '', '', NULL);
...
(9341, '2daw12_minimal2', 'localhost', '2daw12_minimal', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', '2daw12_minimal', 'fk_analisisProfesionales_videojuegos1', 'def', '2daw12_minimal', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'analisisprofesionales', 'videojuegos'),
('def', '2daw12_minimal', 'fk_videojuegos_plataformas', 'def', '2daw12_minimal', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'videojuegos', 'plataformas'),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_usuarios1', 'def', '2daw12_minimal', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'videojuegos_usuarios', 'usuarios'),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_videojuegos1', 'def', '2daw12_minimal', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'videojuegos_usuarios', 'videojuegos');
...
('def', '2daw12_minimal', 'utf8', 'utf8_general_ci', NULL);
...
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'SELECT', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'INSERT', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'UPDATE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'DELETE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'CREATE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'DROP', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'REFERENCES', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'INDEX', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'ALTER', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'CREATE TEMPORARY TABLES', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'LOCK TABLES', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'EXECUTE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'CREATE VIEW', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'SHOW VIEW', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'CREATE ROUTINE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'ALTER ROUTINE', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'EVENT', 'NO'),
('''2daw12_minimal2''@''localhost''', 'def', '2daw12_minimal', 'TRIGGER', 'NO');
...
('INNODB_BUFFER_POOL_READ_AHEAD', '304'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2631677'),
('INNODB_BUFFER_POOL_READS', '4899'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '13794'),
('INNODB_DATA_FSYNCS', '4396'),
...
('def', '2daw12_minimal', 'analisisprofesionales', 0, '2daw12_minimal', 'PRIMARY', 1, 'id_analisis', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 1, '2daw12_minimal', 'fk_analisisProfesionales_videojuegos1_idx', 1, 'videojuego', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', '2daw12_minimal', 'plataformas', 0, '2daw12_minimal', 'PRIMARY', 1, 'id_plataforma', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'usuarios', 0, '2daw12_minimal', 'PRIMARY', 1, 'id_usuario', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos', 0, '2daw12_minimal', 'PRIMARY', 1, 'id_juego', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos', 1, '2daw12_minimal', 'fk_videojuegos_plataformas_idx', 1, 'plataforma', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 0, '2daw12_minimal', 'PRIMARY', 1, 'usuario', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 0, '2daw12_minimal', 'PRIMARY', 2, 'videojuego', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 1, '2daw12_minimal', 'fk_videojuegos_usuarios_usuarios1_idx', 1, 'usuario', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 1, '2daw12_minimal', 'fk_videojuegos_usuarios_videojuegos1_idx', 1, 'videojuego', 'A', 16, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-06-24 16:57:47', '2015-06-24 16:57:47', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 16766844, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2448', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 16332350, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=65280', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 16765866, 0, 0, NULL, '2015-06-24 16:57:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2515', ''),
('def', '2daw12_minimal', 'analisisprofesionales', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, 1, '2015-06-24 12:10:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', '2daw12_minimal', 'plataformas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 0, 6, '2015-06-24 12:10:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', '2daw12_minimal', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 0, 0, 10, '2015-06-24 12:10:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', '2daw12_minimal', 'videojuegos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 16, 1024, 16384, 0, 16384, 0, 31, '2015-06-24 12:10:29', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', '2daw12_minimal', 'videojuegos_usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 16, 1024, 16384, 0, 32768, 0, NULL, '2015-06-24 12:10:29', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', '2daw12_minimal', 'PRIMARY', '2daw12_minimal', 'analisisprofesionales', 'PRIMARY KEY'),
('def', '2daw12_minimal', 'fk_analisisProfesionales_videojuegos1', '2daw12_minimal', 'analisisprofesionales', 'FOREIGN KEY'),
('def', '2daw12_minimal', 'PRIMARY', '2daw12_minimal', 'plataformas', 'PRIMARY KEY'),
('def', '2daw12_minimal', 'PRIMARY', '2daw12_minimal', 'usuarios', 'PRIMARY KEY'),
('def', '2daw12_minimal', 'PRIMARY', '2daw12_minimal', 'videojuegos', 'PRIMARY KEY'),
('def', '2daw12_minimal', 'fk_videojuegos_plataformas', '2daw12_minimal', 'videojuegos', 'FOREIGN KEY'),
('def', '2daw12_minimal', 'PRIMARY', '2daw12_minimal', 'videojuegos_usuarios', 'PRIMARY KEY'),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_usuarios1', '2daw12_minimal', 'videojuegos_usuarios', 'FOREIGN KEY'),
('def', '2daw12_minimal', 'fk_videojuegos_usuarios_videojuegos1', '2daw12_minimal', 'videojuegos_usuarios', 'FOREIGN KEY');
...
('''2daw12_minimal2''@''localhost''', 'def', 'USAGE', 'NO');
